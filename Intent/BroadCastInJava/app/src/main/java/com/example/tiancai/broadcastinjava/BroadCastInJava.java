package com.example.tiancai.broadcastinjava;
...
public class BroadCastInJava extends Activity {
    ...
    class RegisterReceiverListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			BroadCastInJava.this.registerReceiver(smsReceiver, filter);
		}
    ...
    class UnRegisterReceiverListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			BroadCastInJava.this.unregisterReceiver(smsReceiver);
		}
